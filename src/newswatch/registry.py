...
SCRAPERS: Dict[str, ScraperEntry] = {
    ...
    "galamedia": ScraperEntry(
        ...
        strict_search=False,
        smoke_keyword="ekonomi",
        note="content freshness issue: tag page returns articles months old; needs recent content validation",
    ),
    "jpnn": ScraperEntry(
        slug="jpnn",
        ...
        strict_search=False,
        smoke_keyword="ekonomi",
        note="blocked: article pages return blank HTML (JS-rendered); needs Playwright recovery",
    ),
    "surabayapagi": ScraperEntry(
        ...
        strict_search=False,
        smoke_keyword="ekonomi",
        note="blocked: anti-bot protection blocks both HTTP and Playwright requests",
    ),
    "rri": ScraperEntry(
        slug="rri",
        name="RRI (RRI.co.id)",
