...
_SCRAPER_ENTRIES: Tuple[ScraperEntry, ...] = (
    ...
    ScraperEntry(
        ...
        smoke_keyword="ekonomi",
        supports_latest=True,
        note="new; WordPress /?s= search; Sulawesi regional gap; 2026-05-16",
    ),
    ScraperEntry(
        "galamedia",
        "Galamedia",
    ...
    ScraperEntry(
        ...
        smoke_keyword="nasional",
        supports_latest=True,
        note="new; /search?q= endpoint; /read/{id}/{slug} article pattern; lifestyle/pop culture gap; 2026-05-16",
    ),
    ScraperEntry(
        "hipwee",
        "Hipwee",
        "hipwee", "HipweeScraper",
        status="stable",
        strict_search=True,
        concurrency=5,
        smoke_keyword="nasional",
        supports_latest=True,
        note="new; WordPress /?s= search; youth/satire/opinion angle; 2026-05-16",
    ),
    ScraperEntry(
        "idxchannel",
        "IDX Channel",
        "idxchannel", "IDXChannelScraper",
        status="stable",
        strict_search=True,
        concurrency=5,
        smoke_keyword="ihsg",
    ...
    ScraperEntry(
        "infobanknews",
        "Infobanknews",
        "infobanknews", "InfobanknewsScraper",
        status="stable",
        strict_search=True,
        concurrency=5,
        smoke_keyword="bank",
    ...
    ScraperEntry(
        ...
        strict_search=True,
        smoke_keyword="ihsg",
        note="Repeated CloudFront 403 on search and latest paths (2026-07-18); quarantine pending upstream unblock",
        supports_latest=True,
    ),
    ScraperEntry(
        "jakartaglobe",
        "Jakarta Globe",
        "jakartaglobe", "JakartaGlobeScraper",
        status="stable",
        strict_search=True,
        concurrency=5,
        smoke_keyword="nasional",
        supports_latest=True,
        note="new; /search/{keyword} custom endpoint; English coverage; 2026-05-16",
    ),
    ScraperEntry(
        "jakartapost",
        "The Jakarta Post",
    ...
    ScraperEntry(
        ...
        smoke_keyword="nasional",
        supports_latest=True,
        note="new; /tag/{keyword} tag-based search; political commentary; 2026-05-16",
    ),
    ScraperEntry(
        "rri",
        "RRI (RRI.co.id)",
    ...
    ScraperEntry(
        ...
        supports_search=True,
        supports_latest=True,
        note="client-rendered /search/?q= results; server-rendered article pages",
    ),
    ScraperEntry(
        "idnfinancials",
        "IDN Financials",
        "idnfinancials", "IDNFinancialsScraper",
        strict_search=True,
        concurrency=5,
        smoke_keyword="makan bergizi gratis",
        supports_search=True,
        supports_latest=True,
        note="server-rendered /id/search?q= with parser-side relevance filtering",
    ),
    ScraperEntry(
        "wartaekonomi",
        "Warta Ekonomi",
        "wartaekonomi", "WartaEkonomiScraper",
        strict_search=True,
        concurrency=5,
        smoke_keyword="makan bergizi gratis",
        supports_search=True,
    ...
    ScraperEntry(
        ...
        supports_search=True,
        supports_latest=True,
        note="HTTP search works but returned no smoke-keyword items within 30 days; latest emitted 36 items (2026-07-18)",
    ),
    ScraperEntry(
        "dandapala",
        "Dandapala",
        ...
        supports_search=False,
        supports_latest=True,
        note="Latest emitted 8 current items; search intentionally unsupported (2026-07-18)",
    ),
