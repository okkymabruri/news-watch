...
class SindonewsScraper(BaseScraper):
    ...
    since native search does not return results.
    """
    ...
    async def build_search_url(self, keyword, page):
        # https://www.sindonews.com/indeks/0/0
        offset = (page - 1) * 20
        url = f"https://www.{self.base_url}/indeks/0/{offset}"
    ...
    async def get_article(self, link, keyword):
        ...
        try:
            category = ""
            breadcrumb = soup.select_one(".row-content")
            if breadcrumb:
