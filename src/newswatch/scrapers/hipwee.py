"""
Hipwee scraper — uses WordPress search with HTML parsing.

https://www.hipwee.com/?s={keyword}
...
class HipweeScraper(BaseScraper):
    def __init__(self, keywords, concurrency=5, start_date=None, queue_=None):
        super().__init__(keywords, concurrency, queue_)
        self.base_url = "https://www.hipwee.com"
    ...
    def _extract_date(self, soup, link):
        ...
        logging.debug("Hipwee date parse failed | url: %s", link)
        return None
