"""
Poskota scraper — uses tag page with keyword filtering.

https://www.poskota.co.id/tag/KEYWORD
"""
...
class PoskotaScraper(BaseScraper):
    ...
    async def get_article(self, link, keyword):
        ...
        if not publish_date:
            logging.debug("Poskota date parse failed | url: %s | date: %r", link, publish_date_str[:50])
            return
