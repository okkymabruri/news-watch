"""
Mojok scraper — uses WordPress search with HTML parsing.

https://mojok.co/?s={keyword}
...
class MojokScraper(BaseScraper):
    def __init__(self, keywords, concurrency=5, start_date=None, queue_=None):
        super().__init__(keywords, concurrency, queue_)
        self.base_url = "https://mojok.co"
    ...
    def _extract_date(self, soup, link):
        ...
        logging.debug("Mojok date parse failed | url: %s", link)
        return None
